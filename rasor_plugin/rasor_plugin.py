...
class rasor:
    ...
    def __init__(self, iface):
        ...
        """
	global haz, ecat, imp, eatt, evaluation, rapi, first, haz_cat, rlayers
    ...
    def run_download(self):
		global rapi, rset, rlayers, ecat, eatt
		...
		if result and itemS:
			...
			if zipF == -1 or os.stat(zipF).st_size != 0:
				...
				# Case 2: SHP without authentication
					...
					file_tmp=rapi.inverse_translate_file(self.iface, progress, tempDir+'/'+shpfile, eatt, tempfile.mkdtemp(), layerData['type'])
